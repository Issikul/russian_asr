...
\begin{table}[ht]
	\footnotesize
	\centering
	\begin{tabular}{ p{2cm} p{2.5cm} p{1.5cm} p{1.5cm} p{1.5cm} p{1.5cm} p{1.5cm} }
		\toprule
		...
		\hline
		12x1 & orosz\_közepes & N & 9 & 100 & 19.42 & 50.73 \\
		\hline
